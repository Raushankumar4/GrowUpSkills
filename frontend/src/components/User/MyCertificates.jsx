  ...
  return (
    <div className="w-full min-h-screen">
      <h2 className="text-3xl font-bold text-gray-800 mb-10 border-b pb-2">
        🎓 My Certificates <span className="text-sky-600">({certificates?.length || 0})</span>
      </h2>
            ...
            >
              ...
              <div className="p-4">
                ...
                <a
                  ...
                  className="inline-block mt-3 px-4 py-2 bg-sky-600 text-white text-sm rounded-md hover:bg-sky-700 transition"
                >
